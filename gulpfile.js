...
gulp.task('plugins', () => {
    return Promise.all([
        { name: 'RevealHighlight', input: './plugin/highlight/plugin.js', output: './dist/highlight/highlight' },
        { name: 'RevealMarkdown', input: './plugin/markdown/plugin.js', output: './dist/markdown/markdown' },
        { name: 'RevealSearch', input: './plugin/search/plugin.js', output: './dist/search/search' },
        { name: 'RevealNotes', input: './plugin/notes/plugin.js', output: './dist/notes/notes' },
        { name: 'RevealZoom', input: './plugin/zoom/plugin.js', output: './dist/zoom/zoom' },
        { name: 'RevealMath', input: './plugin/math/plugin.js', output: './dist/math/math' },
    ].map( plugin => {
        return rollup({
...
// Define a task to process CSS
gulp.task('minify-css', () => {
    return gulp.src('plugin/highlight/*.css')  // Source folder where your CSS files are located
...
gulp.task('css', gulp.parallel('css-themes', 'css-core', 'minify-css'))
