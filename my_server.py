...
def render():
    ...
    included_files = ['main_cpp', 'CMakeLists_txt', 'robot_urdf', 'getNumJoints_py', 'FFK_cmake', 'robotGen_py',
                      'robotConfig_template','robotConfigCu_template', 'forwardKinematicsLib_cpp', 'godboltOfast_asm',
                      'godboltO3_asm', 'kinematicsInterface_hpp', 'forwardKinematicsTest_cpp', 'inverseKinematicsTest_cpp']
